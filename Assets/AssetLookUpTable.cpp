...
const tableElement AssetLookupTable[] = {
  ...
  {18, "Hilda_D_Stand"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(0, 3), 4, 4, 1, 1 },
  {19, "Hilda_D_Walk1"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(1, 3), 4, 4, 1, 1 },
  {20, "Hilda_D_Walk2"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(2, 3), 4, 4, 1, 1 },
  {21, "Hilda_D_Walk3"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(3, 3), 4, 4, 1, 1 },
  {22, "Hilda_L_Stand"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(0, 2), 4, 4, 1, 1 },
  {23, "Hilda_L_Walk1"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(1, 2), 4, 4, 1, 1 },
  {24, "Hilda_L_Walk2"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(2, 2), 4, 4, 1, 1 },
  {25, "Hilda_L_Walk3"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(3, 2), 4, 4, 1, 1 },
  {26, "Hilda_R_Stand"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(0, 1), 4, 4, 1, 1 },
  {27, "Hilda_R_Walk1"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(1, 1), 4, 4, 1, 1 },
  {28, "Hilda_R_Walk2"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(2, 1), 4, 4, 1, 1 },
  {29, "Hilda_R_Walk3"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(3, 1), 4, 4, 1, 1 },
  {30, "Hilda_U_Stand"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(0, 0), 4, 4, 1, 1 },
  {31, "Hilda_U_Walk1"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(1, 0), 4, 4, 1, 1 },
  {32, "Hilda_U_Walk2"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(2, 0), 4, 4, 1, 1 },
  {33, "Hilda_U_Walk3"  , "Assets/Art/Trainer_Hilda_Spritesheet.png"  , Vector2D(3, 0), 4, 4, 1, 1 },
